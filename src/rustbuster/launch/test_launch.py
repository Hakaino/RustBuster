...
def generate_launch_description():
	...
	tb3_model = os.environ['TURTLEBOT3_MODEL'] if 'TURTLEBOT3_MODEL' in os.environ else 'burger'
	...
	SetEnvironmentVariable("GAZEBO_MODEL_PATH", gazebo_model)
	...
	# Get the path to the exploration configuration file
